...
export default function PrivacyPolicyPage() {
  return (
    <>
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 text-white md:px-8 md:pt-40">
        <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-primary">Legal</p>
        <h1 className="mt-4 font-display text-4xl font-light tracking-tight md:text-5xl">Privacy Policy</h1>
